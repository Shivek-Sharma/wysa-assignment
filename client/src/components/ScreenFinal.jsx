...
function ScreenFinal({ formData }) {
    return (
        <div className="p-3">
            <p className="text-xl">Hey <span className="text-blue-500">{formData.username}</span>, you seem to have a sleep efficiency of {Math.floor(Math.random() * (100 - 85 + 1)) + 85}%</p>
